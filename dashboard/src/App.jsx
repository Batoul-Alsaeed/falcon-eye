...
// ===== DRONE STATUS PANEL =====
function DroneStatusPanel({ mode, onLaunch, onReturn }) {
  return (
    <section className="panel status-panel">
      ...
      <div className="panel-body status-grid">
        <div className="status-item">
          ...
          <span className="value value-green">{mode}</span>
        </div>
        <div className="status-item">
        ...
        <div className="status-item">
          ...
          <span className="value">45 m</span>
        </div>
        <div className="status-item">
          <span className="label">Speed</span>
          <span className="value">38 km/h</span>
        </div>
        <div className="status-item">
          <span className="label">Link</span>
          <span className="value value-green">Secure</span>
        </div>
        <div className="status-item">
          <span className="label">Patrol Distance</span>
          <span className="value">210 m</span>
        </div>
      </div>
